  ...
  return (
    <form onSubmit={handleSubmit} className="relative max-w-5xl mx-auto group">
      <div className="relative">
        ...
        <div className="relative bg-card/80 backdrop-blur-sm border-2 border-border/50 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 hover:border-accent/50">
          <Input
            type="text"
